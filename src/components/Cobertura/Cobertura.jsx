...
const Cobertura = () => {
  ...
  if (questionsList.length === 0) {
    return (
      <div className="view active" style={{ height: '100vh', overflow: 'hidden', display: 'flex', flexDirection: 'column' }}>
        <div style={{ maxWidth: '800px', flex: 1, overflowY: 'auto' }}>
          <div className="card">
  ...
  return (
    <div className="view active" style={{ height: '100vh', overflow: 'hidden', display: 'flex', flexDirection: 'column' }}>
      <div style={{ maxWidth: '900px', flex: 1, overflowY: 'auto', paddingRight: '8px' }}>
        {/* Estatísticas Gerais */}
